...
function displayCart() {
  ...
  for (i in localStorage) {
    ...
    if (/^cart/.test(i)) {
      ...
      str += `<tr>
                  <td id="tdName">${itemName}</td>
                  <td id="tdPrice">${itemPrice}</td>
                  <td id="tdQty"><button class="decrease">-</button>${itemQty}<button class="increase">+</button></td>
                  <td id="tdTotal">${itemQty*itemPrice}</td>
                  <td id="tdRemove"><button class="removeBtn" id='${cartItem}'>Remove</button></td>
                </tr>`
    }
  }
  ...
  summary = ` <p>Produse: ${count}</p>
              <p>TVA: 0%</p>
              <p>Transport: 0  <i class="fas fa-euro-sign"></i></p>
              <h5>TOTAL : ${total} <i class="fas fa-euro-sign"></i></h5>
              <hr>
